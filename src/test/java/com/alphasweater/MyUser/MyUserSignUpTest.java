...
public class MyUserSignUpTest {
    ...
    public void testRegisterUser() {
        ...
        String result1 = MyUserSignUp.registerUser(true,"us_r4", "Password123!", "Tom", "Hanks", userDatabase);
        ...
        String result2 = MyUserSignUp.registerUser(true,"us", "Password123!", "Invalid", "Username", userDatabase);
        ...
        String result3 = MyUserSignUp.registerUser(true,"us_r5", "password", "Invalid", "Password", userDatabase);
        ...
        String result4 = MyUserSignUp.registerUser(true,"us_r2", "Password123!", "Username", "Exists", userDatabase);
