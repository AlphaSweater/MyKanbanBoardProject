...
public class MyUserSignUpTest {
    ...
    public void testRegisterUser() {
        ...
        String result1 = MyUserSignUp.toTestRegisterUser("us_r4", "Password123!", "Tom", "Hanks", userDatabase);
        assertTrue("Registration should succeed for valid input.", MyUserSignUp.getIsRegistered());
        assertEquals("Welcome Tom Hanks, it is great to have you join us.", result1);

        // Test for an invalid username
        String result2 = MyUserSignUp.toTestRegisterUser("us", "Password123!", "Invalid", "Username", userDatabase);
        assertFalse("Registration should fail for an invalid username.", MyUserSignUp.getIsRegistered());
        ...
        String result3 = MyUserSignUp.toTestRegisterUser("us_r5", "password", "Invalid", "Password", userDatabase);
        assertFalse("Registration should fail for an invalid password.", MyUserSignUp.getIsRegistered());
        ...
        String result4 = MyUserSignUp.toTestRegisterUser("us_r2", "Password123!", "Username", "Exists", userDatabase);
        assertFalse("Registration should fail for an existing username.", MyUserSignUp.getIsRegistered());
